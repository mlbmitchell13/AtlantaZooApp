...
public class ShowHistoryPage extends Pane {

    public ShowHistoryPage(Stage stage, String username) {
        super();
        ...
        HBox buttonBox = new HBox(15, search, back);

        Text header = new Text("Show History");
        ...
        showInfo.getColumns().addAll(showName, showDate, showExhibit);
