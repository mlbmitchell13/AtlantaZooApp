...
public class AdminViewAnimalsPage extends Pane {

    public AdminViewAnimalsPage(Stage stage, String username) {
        super();
        ...
        this.getChildren().addAll(background, nameBox, speciesBox, ageBox,
                exhibitBox, search, animalInfo, atlHeader, typeBox, header,
                backBtn, delete);

        search.relocate(250, 210);
        ...
        header.setX(50);
        header.setY(40);
        backBtn.relocate(330, 210);
        delete.relocate(400, 210);
